...
class Application:
    ...
    def __init__(self):
        ...
        self.model = load_model("C:\\Users\\Pravalika Chitloju\\Desktop\\project\\cnn8grps_rad1_model.h5")
        self.ct = {}
        self.ct['blank'] = 0
        self.blank_flag = 0
    ...
    def video_loop(self):
        try:
            ...
            if hands:
                hand = hands[0]
                white = cv2.imread("C:\\Users\\Pravalika Chitloju\\Desktop\\project\\white.jpg")
                if len(hand)>0:
                    bbox = hand[0]['bbox']
